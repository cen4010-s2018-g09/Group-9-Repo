      ...
      try{
        ...
        if(count($result)>0)
        {
            ...
            for($i=0;$i<count($result);$i++)
            {
                ...
                $keywords =$row['Keyword1'].', '.$row['Keyword2'] ;
                $description = str_replace('"','',$description);
                
                if ($pType == "Student"){

                echo "displayItems('".$part_number."','".$part_name."','".$vendor."','".$price."','".$quantity."','".$description."','".$keywords."');";
                
                }
                else{
               echo "displayItemsA('".$part_number."','".$part_name."','".$vendor."','".$price."','".$quantity."','".$description."','".$keywords."');";
                }
              }
        }
