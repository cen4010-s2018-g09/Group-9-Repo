      ...
      try{
        ...
        if(count($result)>0)
        {
            ...
            for($i=0;$i<count($result);$i++)
            {
                ...
                $vendor_point_of_contact =$row['Vendor_Point_Of_Contact'];
                $vendor_contact_email =$row['Vendor_Contact_Email'];
                $vendor_items =$row['Vendor_Items'];
                
                echo 'displayVendors("'.$vendor_name.'","'.$vendor_website.'","'.$vendor_address.'","'.$vendor_phone_number.'","'.$vendor_point_of_contact.'","'.$vendor_contact_email.'","'.$vendor_items.'");';
