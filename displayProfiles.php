...
echo "<script>createProfile('".$order_number."','".$order_date."','".$order_type."','".$user_name."');</script>";
...
echo "<script>appendToProfile('".$order_number."','".$part_name."','".$part_number."','".$status."','".$quantity."');</script>";
}
}
