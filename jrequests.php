...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top fixed-top-2">
    ...
    <div >
        ...
        <div class="col" style="margin-right:0.5rem;">
            ...
            <div class="form-inline" id="filterBar">
                    ...
                    <button class="btn btn-outline-warning btn-sm" onclick="displayJobRequests('Pending');">Pending</button>

                    <button class="btn btn-outline-success btn-sm" onclick="displayJobRequests('Approved');">Approved</button>

                    <button class="btn btn-outline-danger btn-sm" onclick="displayJobRequests('Rejected');">Rejected</button>

                    <button class="btn btn-outline-secondary btn-sm" onclick="displayJobRequests('');">All</button>
    ...
    <script src="js/jrequests.js"></script>
