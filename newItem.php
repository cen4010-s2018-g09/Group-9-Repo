...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top fixed-top-2">
    ...
    <div >
        ...
        <div id="newItem-form" class="col-7">
            <h1>New Item Form</h1>
            <p>Please fill out all fields for the new inventory item.</p>
                ...
                <form  method="post">
                        ...
                        <div class="form-group">
                          <label for="vendor">Vendor P/N</label>
                        ...
                        <div class="form-group">
                          <label for="location">Location in Lab</label>
...
try{
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
  $sql = "INSERT INTO Inventory VALUES ('$part_number','$part_name','$keywords','NA','$vendor','$quantity','$price','$location', '$description');";
    $conn->exec($sql);
        
echo "alert('Your item has been added to the database successfully');";
