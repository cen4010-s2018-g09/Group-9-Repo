...
<html lang="en">
  ...
  if(isset($_POST['view'])){
    $_SESSION["part_name"] = $_COOKIE["name"];
    $_SESSION["part_number"] = $_COOKIE["number"];
    $_SESSION["vendor"] = $_COOKIE["vendor"];
    $_SESSION["price"] = $_COOKIE["price"];
    $_SESSION["quantity"] = $_COOKIE["quantity"];
    $_SESSION["description"] = $_COOKIE["description"];
    echo 'window.location = "itemDetails.php";';
  }     
