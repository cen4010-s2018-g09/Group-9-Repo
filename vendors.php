        ...
        <div id="newItem-form" class="col-5">
            ...
            <p>Please fill out all fields for creating a new vendor in the system.</p>
                ...
                <form  method="post">
                        ...
                        <div class="form-group">
                          <label for="vendor_point_of_contact">Vendor Point of Contact</label>
                          <input type="text" class="form-control" name="vendor_point_of_contact" placeholder="">
                        </div>
                         <div class="form-group">
...
if(isset($_POST['SubmitButton'])){
  ...
  $_SESSION["vendor_point_of_contact"] = $_POST['vendor_point_of_contact'];
...
try{
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
  $sql = "insert into Vendors values ('$vendor_name','$vendor_website ','$vendor_address','$vendor_phone_number','$vendor_point_of_contact','$vendor_contact_email','$vendor_items')";
    $conn->exec($sql);
