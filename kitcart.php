...
session_start();
      ...
      try{
        ...
        $stmt = $conn->prepare("SELECT * FROM KitCart WHERE Account_Number = '$userID';"); 
        $stmt->execute();
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top fixed-top-2">
    ...
    <!-- Custom JavaScript -->
    <script src="js/KitCartItems.js"></script>
    <script src="js/homePage.js"></script>
    <script src="js/CreateKit.js"></script>
      ...
      try{
        ...
        if(count($result)>0)
        {
            ...
            for($i=0;$i<count($result);$i++)
            {
                ...
                echo 'displayKitItems("'.$part_number.'","'.$part_name.'","'.$quantity.'","'.$description.'");';
                
              }
            echo 'KitName("'.$part_number.'","'.$part_name.'","'.$quantity.'","'.$description.'");';
        }
